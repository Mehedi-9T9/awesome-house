    ...
    return (
        <div className='my-10 flex gap-20 justify-center'>
            ...
            <div className='bg-base-300 flex gap-x-20 p-20 rounded-xl drop-shadow-md'>
                <h2 className='text-yellow-500 text-3xl font-bold'>{coupons.offer}% <span className='text-[#F63E7B]'>Off</span></h2>
                <h2 className='text-xl font-poppins'>{coupons.coupon}</h2>
            </div>
